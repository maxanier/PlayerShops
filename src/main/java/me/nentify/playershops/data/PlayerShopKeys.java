...
public class PlayerShopKeys {
    ...
    public static final Key<Value<ItemStack>> ITEM = KeyFactory.makeSingleKey(TypeToken.of(ItemStack.class),new TypeToken<Value<ItemStack>>(){},DataQuery.of("ItemStack"),PlayerShops.PLUGIN_ID+":itemstack","itemstack");
    ...
    public static final Key<Value<String>> OWNER_UUID = KeyFactory.makeSingleKey(TypeToken.of(String.class), new TypeToken<Value<String>>() {}, DataQuery.of("OwnerUuid"),PlayerShops.PLUGIN_ID+":owneruuid","owneruuid");
}
